...
# Results
Now we're all ready to go. This is what it looks like to execute some commands over the narrowband channel: ![narrowband c2](https://www.johnmathot.com/assets/img/narrowband_c2.png)

And over the broadband channel:![broadband c2](https://www.johnmathot.com/assets/img/broadband_c2.png)
...
It looks like...![packet capture](https://www.johnmathot.com/assets/img/wshark_1.png)
...
Let's start another packet capture, this time dumping the TLS session keys to a log so we can decrypt the traffic:![decrypted packets](https://www.johnmathot.com/assets/img/wshark_2.png)
...
Let's take a look at when the client received the `whoami` command over the broadband channel:![whoami](https://www.johnmathot.com/assets/img/whoami.png)
...
Let's go back and search for that signature so we can look at the packet where it happens:![whoami_packet](https://www.johnmathot.com/assets/img/whoami_packet.png)
